...
# Add "Demo" tag to header
st.markdown("<div style='background-color: #4F8BF9; padding: 5px; border-radius: 5px; width: fit-content;'><span style='color: white; font-weight: bold;'>DEMO</span></div>", unsafe_allow_html=True)
